  ...
  return (
    ...
    >
      <div className="backdrop-blur-sm rounded-full px-6 sm:px-8  py-4 flex items-center justify-between gap-6  lg:gap-12 mx-auto border border-gray-100">
        {/* Logo */}
        <Link href="/" className="flex items-center gap-2 font-bold " aria-label="العودري">
          ...
          {navLinks.map((link) => {
            ...
            return (
              <Link
                ...
                className={
                  isContact
                    ? "bg-primary text-primary-foreground px-6 py-2 rounded-full font-body font-medium text-base transition-all duration-200 hover:opacity-90 hover:shadow-lg whitespace-nowrap"
                    : "text-foreground/80 hover:text-foreground font-body font-medium text-base transition-colors duration-200 relative group whitespace-nowrap"
                }
              >
                {link.label}
                {!isContact && (
            ...
            {navLinks.map((link) => {
              ...
              return (
                <Link
                  ...
                  className={
                    isContact
                      ? "mx-4 px-6 py-3 bg-primary text-primary-foreground rounded-full hover:opacity-90 font-body font-medium text-sm transition-all duration-200 text-center"
                      : "px-6 py-3 text-foreground/80 hover:text-foreground hover:bg-gray-50 font-body font-medium text-sm transition-colors duration-200"
                  }
                >
                  {link.label}
                </Link>
